    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: Colors.basic.white }}>
      <View style={styles.balanceCard}>
        <View style={styles.headerRow}>
          <Text style={{fontSize: Font.md, color: Colors.basic.white,}}>Hello <Text style={{fontFamily: "bold", color: Colors.basic.white}}>{userName}</Text></Text>
          <Ionicons name="wallet" size={24} color={Colors.basic.white} />
        </View>
        <Text style={{fontSize: Font.sm, color: Colors.basic.white,  marginTop: 10}}>Your Wallet Balance</Text>
        <Text style={{fontFamily: "bold", fontSize: Font.xl, color: Colors.basic.white,  marginTop: 10}}>$ {balance.toFixed(2)}</Text>
      </View>

      <Pressable style={styles.withdrawCard}>
        <MaterialCommunityIcons name="bank-transfer-out" size={24} color={Colors.basic.red} />
        <Text style={ {fontSize: Font.md, color: Colors.basic.black}}>Withdraw from Wallet</Text>
      </Pressable>

      <View style={styles.transactionsHeader}>
        <Text style={{ fontSize: Font.md, color: Colors.basic.black}}>Transactions</Text>
        <Text style={{ fontSize: Font.xs, color: Colors.basic.blue}}>See All</Text>
      </View>
